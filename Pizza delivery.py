...
print(
    f"Cost for {c.get_quantity()} pizzas({p.get_service_id()}) : {p.pizza_cost}")

d.calculate_pizza_cost()
print(f"Cost for {c.get_quantity()} pizzas({d.get_service_id()}) : {d.pizza_cost} \nDoor delivery charges   : {d.get_delivery_charge()} ")
